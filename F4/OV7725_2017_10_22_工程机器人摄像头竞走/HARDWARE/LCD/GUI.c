...
{
	LCD_ShowString(0 + x_offset , 272 + y_offset, 48 ,16,16 , "MODE 1",1);
	LCD_ShowString(80 + x_offset , 272 + y_offset, 48 ,16,16 , "MODE 2",1);
	LCD_ShowString(160 + x_offset , 272 + y_offset, 48 ,16,16 , "MODE 3",1);
	LCD_ShowString(0 + x_offset , 296 + y_offset, 48 ,16,16 , "MODE 4",1);
	LCD_ShowString(80 + x_offset , 296 + y_offset, 48 ,16,16 , "MODE 5",1);
	LCD_ShowString(160 + x_offset , 296 + y_offset, 52 ,16,16 , "START",1);
}
