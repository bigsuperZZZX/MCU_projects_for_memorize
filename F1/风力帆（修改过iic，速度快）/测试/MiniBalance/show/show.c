...
void oled_show(void)
{
	  ...
	  //=============第二行显示温度和距离===============//	
													OLED_ShowNum(0,10,Temperature/10,2,12);
													OLED_ShowNum(23,10,Temperature%10,1,12);
													OLED_ShowString(13,10,".");
													OLED_ShowString(35,10,"`C");
													OLED_ShowNum(70,10,(u16)Distance,5,12);
  	...
  	//=============第四行显示编码器2=======================//		
		...
		//=============第五行显示电压=======================//
		                      ...
		                      OLED_ShowNum(45,40,Voltage/100,2,12);
		                      OLED_ShowNum(68,40,Voltage%100,2,12);
		 if(Voltage%100<10) 	OLED_ShowNum(62,40,0,2,12);
		//=============第六行显示角度=======================//
		                      OLED_ShowString(0,50,"Angle");
		if(Angle_Balance<0)		OLED_ShowNum(45,50,Angle_Balance+360,3,12);
		else					        OLED_ShowNum(45,50,Angle_Balance,3,12);
		//=============刷新=======================//
//		OLED_Refresh_Gram();	
	}
/**************************************************************************
