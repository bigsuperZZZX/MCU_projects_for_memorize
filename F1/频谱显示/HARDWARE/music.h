...
//灯引脚定义，从最左至右
//	B14 A2 A3 | A6 A8 A9 | A10 A11 A12 | B8 B9 B10 | B11 B12 B13 | B5 B6 B7
...
#define L31_ON() GPIO_SetBits(GPIOA,GPIO_Pin_10)
...
#define L31_OFF() GPIO_ResetBits(GPIOA,GPIO_Pin_10)
